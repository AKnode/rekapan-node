...
echo -e "\e[1m\e[31m[+] Buildding... \e[0m" && sleep 1
# download binary
...
echo
echo -e "Your TERITORI node \e[32minstalled and works\e[39m!"
echo -e "status sync: \e[1m\e[32mteritorid status 2>&1 | jq .SyncInfo\e[0m"
echo -e 'logs: \e[1m\e[32msudo journalctl -u teritorid -f --no-hostname -o cat\e[0m'