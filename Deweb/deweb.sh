...
# set vars
if [ ! $NODENAME ]; then
	read -p "\e[1m\e[32mNama node : \e[0m" NODENAME
...
echo -e "chain name: \e[1m\e[32m$DEWEB_CHAIN_ID\e[0m"
echo -e "port: \e[1m\e[32m$DEWEB_PORT\e[0m"
echo '----------------------------🌀'
sleep 2
...
echo -e "\e[1m\e[32m3. build binaries... \e[0m" && sleep 1
# download binary
cd $HOME
